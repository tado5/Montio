...
/**
 * EXAMPLE: Company Admin Dashboard with new Layout
 *
 * This is an example of how to use the new Layout component.
 * The Layout component includes Header, Sidebar, and Footer automatically.
 *
 * To apply this to all pages:
 * 1. Import Layout from '../components/Layout'
 * 2. Wrap your page content in <Layout title="..." subtitle="...">
 * 3. Remove old Header/Sidebar/Footer imports and JSX
 */
