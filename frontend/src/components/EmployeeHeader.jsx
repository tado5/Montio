        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <button
              ...
              className="lg:hidden p-2 hover:bg-emerald-500/10 rounded-lg transition-all border border-emerald-500/0 hover:border-emerald-500/30"
            ...
            <div className="flex-1 min-w-0 flex items-center gap-3">
              <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 border border-emerald-500/30 rounded-lg backdrop-blur-sm">
                <Wrench className="w-4 h-4 text-emerald-400" />
                <span className="font-mono text-xs text-emerald-300 tracking-wider">FIELD</span>
              </div>

              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <h1 className="text-xl md:text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-green-300 to-emerald-400 animate-pulse truncate" style={{ fontFamily: "'Archivo Black', sans-serif" }}>
                    {title}
                  </h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-2 px-3 py-1.5 bg-slate-900/50 border border-slate-700/50 rounded-lg">
              ...
              <div className="flex flex-col">
                <span className="text-[10px] font-mono text-slate-500 leading-none">TODAY</span>
                <span className="text-xs font-mono text-green-400 leading-none font-bold">3</span>
              </div>
            </div>
