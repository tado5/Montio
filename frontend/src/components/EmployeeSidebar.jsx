...
const EmployeeSidebar = ({ isMobileMenuOpen, onClose, isCollapsed, onToggleCollapse }) => {
  ...
  const menuItems = [
    { Icon: LayoutDashboard, label: 'Dashboard', path: '/employee', description: 'Môj prehľad' },
    { Icon: Calendar, label: 'Môj kalendár', path: '/employee/calendar', disabled: true, description: 'Rozpis úloh' },
    { Icon: FileText, label: 'Moje úlohy', path: '/employee/tasks', disabled: true, description: 'Aktívne projekty' },
    { Icon: Camera, label: 'Fotky', path: '/employee/photos', disabled: true, description: 'Galéria montáží' },
    { Icon: Briefcase, label: 'Voľno', path: '/employee/time-off', disabled: true, description: 'Dovolenka' },
  ]
  ...
  return (
    <>
      ...
      >
        ...
        <div className="hidden lg:block relative px-3 py-2.5 border-b border-emerald-500/20">
          {isCollapsed ? (
                    ...
                    className={`
                      ...
                      ${
                        active
                          ...
                          : 'text-slate-300 hover:text-white hover:bg-slate-800/50 hover:border-emerald-500/30 border border-transparent'
                      }
                    `}
        ...
        {/* Bottom actions */}
        <div className="relative p-2 lg:p-3 space-y-1 lg:space-y-1.5 border-t border-emerald-500/20">
          {/* Help Button */}
          <button
            onClick={() => setIsInfoOpen(true)}
            className="w-full flex items-center justify-center gap-1.5 px-2 py-1.5 lg:px-3 lg:py-2 bg-slate-900/50 hover:bg-slate-800/50 border border-slate-700/50 hover:border-emerald-500/30 rounded-lg transition-all text-[11px] lg:text-[13px] font-mono text-slate-300 hover:text-white"
          ...
          <button
            ...
            className="hidden lg:flex w-full items-center justify-center gap-1.5 px-3 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 hover:border-emerald-500/50 rounded-lg transition-all text-[13px] font-mono font-bold text-emerald-400 hover:text-emerald-300"
