...
VALUES ('***REMOVED***', '$2a$10$NEFeeSV5VkIRzSSvkB92Beu4J4zfjajVvDsrZ2PUs7eL.0ujnj0e2', 'superadmin', NULL);

-- Company Admin (password: ***REMOVED***)
INSERT INTO `users` (`email`, `password_hash`, `role`, `company_id`)
VALUES ('***REMOVED***', '$2a$10$l5rtIgkeos2IuyCQKie0YO1LCCBCuPrF4ERkNB1ISeM5w69oXD6p6', 'companyadmin', 1);

-- Employee (password: ***REMOVED***)
INSERT INTO `users` (`email`, `password_hash`, `role`, `company_id`)
VALUES ('***REMOVED***', '$2a$10$ILZT4CifUZdBNKHWaMCdvOo9rn1Ljjs.U9USYuNZfjURWOYLMJbRi', 'employee', 1);
