...
```bash
mysql -u ***REMOVED*** -p -h localhost d46895_montio
```
...
```bash
mysql -u ***REMOVED*** -p -h localhost d46895_montio < database/schema.sql
```
...
3. Prihlás sa ako super admin: `***REMOVED***` / `***REMOVED***`
