...
router.post('/', verifyToken, requireRole('superadmin'), asyncHandler(async (req, res) => {
...
router.get('/:publicId', verifyToken, requireRole('superadmin'), asyncHandler(async (req, res) => {
...
router.get('/:publicId/logs', verifyToken, requireRole('superadmin'), asyncHandler(async (req, res) => {
  const { publicId } = req.params;
...
router.put('/:publicId/deactivate', verifyToken, requireRole('superadmin'), asyncHandler(async (req, res) => {
  const { publicId } = req.params;
...
router.put('/:publicId/activate', verifyToken, requireRole('superadmin'), asyncHandler(async (req, res) => {
  const { publicId } = req.params;
...
router.delete('/:publicId', verifyToken, requireRole('superadmin'), asyncHandler(async (req, res) => {
  const { publicId } = req.params;
