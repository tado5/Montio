...
router.get('/', verifyToken, requireRole('companyadmin', 'employee'), asyncHandler(async (req, res) => {
...
router.post('/', verifyToken, requireRole('companyadmin'), asyncHandler(async (req, res) => {
...
router.put('/:id', verifyToken, requireRole('companyadmin'), asyncHandler(async (req, res) => {
  const { id } = req.params;
  const { name, description } = req.body;
  const userId = req.user.id;
...
router.delete('/:id', verifyToken, requireRole('companyadmin'), asyncHandler(async (req, res) => {
  const { id } = req.params;
  const userId = req.user.id;
